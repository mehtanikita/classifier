                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <form action="search.jsp">
	                       	<div id="search_div">
	                       		<input type="text" name="q" id="search_box" autofocus autocomplete="new-password" placeholder="What are you looking for?" title="Search here.." required oninvalid="this.setCustomValidity('Please enter search string')" onkeyup="this.setCustomValidity('')"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="list-inline banner-social-buttons">
                        ...
                        <li>
                            <a href="https://github.com/mehtanikita/classifier" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                        </li>
                        <li>
